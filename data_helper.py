...
def find_parameters(learning_rate,drop_out, batch_size, optimizer):
    '''
        Takes hyperparameters as inputs
        Creates parameter permutations
    '''
   
    permutations = np.array(np.meshgrid(learning_rate,drop_out,  batch_size, optimizer )).T.reshape(-1,4)
